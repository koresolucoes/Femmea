...
export const JOURNEY_STAGES: JourneyStageDefinition[] = [
  ...
  },
  {
    ...
    shortDescription: "Monitore seu ciclo e receba alertas nos momentos importantes",
  ...
  },
  {
    ...
    shortDescription: "Tudo o que você precisa saber para se sentir segura e tranquila",
  ...
  },
  {
    ...
    shortDescription: "Cuidados, sinais e orientações para cada fase da espera",
  ...
  },
  {
    ...
    shortDescription: "Resultado · acompanhe a data definida para o teste",
...
export const CHECKLIST_TEMPLATE: ChecklistTemplateItem[] = [
  ...
  { key: "requested_exams", label: "Exames solicitados", stage: "planning", sortOrder: 20 },
  { key: "medication_plan", label: "Início da medicação", stage: "planning", sortOrder: 30 },
  ...
  { key: "procedure_day", label: "Dia da inseminação", stage: "insemination_day", sortOrder: 70 },
  { key: "post_care", label: "Repouso e cuidados", stage: "post_procedure", sortOrder: 80 },
  { key: "pregnancy_test", label: "Teste de gravidez", stage: "pregnancy_test", sortOrder: 90 },
];
...
export const CONTENT_LIBRARY = [
  ...
  { slug: "alimentacao-e-rotina", title: "Alimentação e suplementação", category: "Bem-estar", icon: "heart" },
